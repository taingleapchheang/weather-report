...
var convertKtoF = function convertKtoF(temp) {
  return (temp - 273.15) * (9 / 5) + 32;
};

var findLatAndLong = function findLatAndLong() {
  //let lat, long;
  _axios.default.get('https://weather-report-proxy-server.herokuapp.com/location', {
    params: {
      q: state.city
    }
...
var getWeather = function getWeather() {
  _axios.default.get('https://weather-report-proxy-server.herokuapp.com/weather', {
    params: {
      lat: state.lat,
      lon: state.long
    }
...
var updateSky = function updateSky() {
  var inputSky = document.getElementById('skySelect').value;
  var skyContainer = document.getElementById('sky');
  var sky = '';
  var skyColor = '';
  ...
  var gardenContent = document.getElementById('gardenContent');
  gardenContent.classList = "garden__content ".concat(skyColor);
};

var updateCityName = function updateCityName() {
  var inputName = document.getElementById('cityNameInput').value;
  var headerCityName = document.getElementById('headerCityName');
  state.city = inputName;
  headerCityName.textContent = state.city;
};

var resetCityName = function resetCityName() {
  var cityNameInput = document.getElementById('cityNameInput');
  cityNameInput.value = 'Seattle';
  updateCityName();
};

var formatTempAndGarden = function formatTempAndGarden() {
  var temp = state.temp;
  var color = 'red';
  var landscape = '🌵__🐍_🦂_🌵🌵__🐍_🏜_🦂';
  ...
  var newLandscape = document.getElementById('landscape');
...
var registerEventHandlers = function registerEventHandlers() {
  formatTempAndGarden();
  var currentTempButton = document.getElementById('currentTempButton');
  currentTempButton.addEventListener('click', findLatAndLong);
  var increaseTempControl = document.getElementById('increaseTempControl');
  increaseTempControl.addEventListener('click', increaseTemp);
  var decreaseTempControl = document.getElementById('decreaseTempControl');
  decreaseTempControl.addEventListener('click', decreaseTemp);
  updateCityName();
  var cityNameInput = document.getElementById('cityNameInput');
  cityNameInput.addEventListener('input', updateCityName);
  var cityNameResetBtn = document.getElementById('cityNameReset');
